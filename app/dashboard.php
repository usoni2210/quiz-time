...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    ...
    <title>QUIZ TIME || DASHBOARD </title>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            <li <?php if (@$_GET['q'] == 0) echo 'class="active"'; ?>><a href="dashboard.php?q=0">Home<span
    ...
    <div class="container-fluid"><!--container start-->
      <div class="row">
        <div class="col-xs-12">
            ...
            while ($row = mysqli_fetch_array($result)) {
              echo '
                            <tr>
                                ...
                                <td>' . $row['mob'] . '</td>
                                <td>
                                    <a title="Delete User" href="update.php?demail=' . $row['id'] . '">
          ...
          <?php
          if (@$_GET['q'] == 2) {
            $res = mysqli_query($con, "SELECT * FROM rank  ORDER BY score DESC ") or die('Error Rank');
            ...
            while ($row = mysqli_fetch_array($res)) {
              $id = $row['user_id'];
              $s = $row['score'];
              $q12 = mysqli_query($con, "SELECT * FROM user WHERE id='$id' ") or die('Error');
          ...
          if (@$_GET['q'] == 3) {
            ...
            while ($row = mysqli_fetch_array($result)) {
              ...
              echo '
                              <tr>
                                  <td>' . $c++ . '</td>
                                  <td><a title="Click to open feedback" href="dashboard.php?q=3&fid=' . $row['id'] . '">' . $row['subject'] . '</a></td>
                                  <td>' . $row['email'] . '</td>
                                  <td>' . $date . '</td>
                                  <td>' . $row['time'] . '</td>
                                  <td>' . $row['name'] . '</td>
                                  <td>
                                      <a title="Open Feedback" href="dashboard.php?q=3&fid=' . $row['id'] . '">
                                          <b><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span></b>
                                      </a>
                                  </td>
                                  <td>
                                      <a title="Delete Feedback" href="update.php?fdid=' . $row['id'] . '">
                                          <b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b>
                                      </a>
                                  </td>
                              </tr>';
          ...
          <?php
            if (@$_GET['fid']) {
              ...
              while ($row = mysqli_fetch_array($result)) {
                ...
                echo '<div class="panel">
                        <a title="Back to Archive" href="dashboard.php?q=3">
          ...
          <?php
            if (@$_GET['q'] == 4 && !(@$_GET['step'])) {
              echo ' <div class="row">
                          <span class="col-xs-12 text-center title1" style="font-size:30px;"">
                              <b>Enter Quiz Details</b><br>
                          </span><br /><br />
                              ...
                              <form class="form-horizontal title1" name="form" action="update.php?q=addquiz"  method="POST">
                                  <fieldset>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-12">
                                              <input id="wrong" name="wrong" placeholder="Minus Marks on Wrong Answer Without Sign" class="form-control input-md" min="0" type="number">
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-12">
                                              <input id="time" name="time" placeholder="Time Limit for Test in Seconds" class="form-control input-md" min="1" type="number">
                                          </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-12">
                                              <input id="tag" name="tag" placeholder="#Tag Which is Used for Searching" class="form-control input-md" type="text">
                                          </div>
                                      </div>
            ...
            if (@$_GET['q'] == 5) {
              ...
              while ($row = mysqli_fetch_array($result)) {
                ...
                echo '          <tr>
                                    ...
                                    <td>' . $row['time'] . '&nbsp;Min</td>
                                    <td>
                                        <b><a href="update.php?q=rmquiz&eid=' . $eid . '" class="pull-right btn sub1" style="margin:0px;background:red">
